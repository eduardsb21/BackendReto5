const endpointCat = "http://152.67.54.209:8082/api/Category/all";
...
function peticionpostCat() {
    $.ajax({
      method: "POST",
      url: "http://152.67.54.209:8082/api/Category/save",
  ...
  function peticionputCat() {
    $.ajax({
      method: "PUT",
      url: "http://152.67.54.209:8082/api/Category/update",
      data: capturarcategoria(),
      datatype: "json",
      contentType: "application/json",
      complete: function (response) {
  ...
  function peticionDeleteCat() {
    $.ajax({
      method: "DELETE",
      url:"http://152.67.54.209:8082/api/Category/delete" ,
      data: captIdCat(),
      datatype: "json",
      contentType: "application/json",
      complete: function (response) {
