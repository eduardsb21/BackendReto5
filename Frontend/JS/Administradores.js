const endpointAdm = "http://152.67.54.209:8082/api/Admin/all";
...
function peticionpostAdm() {
  $.ajax({
    method: "POST",
    url: "http://152.67.54.209:8082/api/Admin/save",
...
function peticionputAdm() {
  $.ajax({
    method: "PUT",
    url: "http://152.67.54.209:8082/api/Admin/update",
    data: capturarAdministradores(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
...
function peticionDeleteAdm() {
  $.ajax({
    method: "DELETE",
    url: "http://152.67.54.209:8082/api/Admin/delete",
    data: captIdAdm(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
