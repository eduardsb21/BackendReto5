...
function PeticiongetReportStatus() {
  $.ajax({
    method: "GET",
    url: "http://152.67.54.209:8082/api/Reservation/report-status",
...
function peticiongetReportFecha() {
  ...
  $.ajax({
    url:
      "http://152.67.54.209:8082/api/Reservation/report-dates/" +
      fechaInicio +
      "/" +
      fechaCierre,
    type: "GET",
...
function PeticiongetReportClients() {
  $.ajax({
    method: "GET",
    url: "http://152.67.54.209:8082/api/Reservation/report-clients",
    success: function (data) {
      console.log(data);
