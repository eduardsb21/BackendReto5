const endpointRes = "http://152.67.54.209:8082/api/Reservation/all";
...
function peticionpostRes() {
  $.ajax({
    method: "POST",
    url: "http://152.67.54.209:8082/api/Reservation/save",
...
function peticionputRes() {
  $.ajax({
    method: "PUT",
    url: "http://152.67.54.209:8082/api/Reservation/update",
    data: capturarReservas(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
...
function peticionDeleteRes() {
  $.ajax({
    method: "DELETE",
    url: "http://152.67.54.209:8082/api/Reservation/delete",
    data: captIdRes(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
