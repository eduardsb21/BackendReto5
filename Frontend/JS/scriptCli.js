const endpointCli = "http://152.67.54.209:8082/api/Client/all";
...
function peticionpostCli() {
  $.ajax({
    method: "POST",
    url: "http://152.67.54.209:8082/api/Client/save",
...
function peticionputCli() {
  $.ajax({
    method: "PUT",
    url: "http://152.67.54.209:8082/api/Client/update",
    data: capturarClientes(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
...
function peticionDeleteCli() {
  $.ajax({
    method: "DELETE",
    url: "http://152.67.54.209:8082/api/Client/delete",
    data: captIdCli(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
