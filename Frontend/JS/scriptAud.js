const endpointAud = "http://152.67.54.209:8082/api/Audience/all";
...
function peticionpostAud() {
  $.ajax({
    method: "POST",
    url: "http://152.67.54.209:8082/api/Audience/save",
...
function peticionputAud() {
  $.ajax({
    method: "PUT",
    url: "http://152.67.54.209:8082/api/Audience/update",
    data: capturarAuditorio(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
...
function peticionDeleteAud() {
  $.ajax({
    method: "DELETE",
    url: "http://152.67.54.209:8082/api/Audience/delete",
    data: captIdAud(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
