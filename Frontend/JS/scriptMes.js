const endpointMes = "http://152.67.54.209:8082/api/Message/all";
...
function peticionpostMes() {
  $.ajax({
    method: "POST",
    url: "http://152.67.54.209:8082/api/Message/save",
...
function peticionputMes() {
  $.ajax({
    method: "PUT",
    url: "http://152.67.54.209:8082/api/Message/update",
    data: capturarMensajes(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
...
function peticionDeleteMes() {
  $.ajax({
    method: "DELETE",
    url: "http://152.67.54.209:8082/api/Message/delete",
    data: captIdMes(),
    datatype: "json",
    contentType: "application/json",
    complete: function (response) {
